...
<div class="container">
    ...
    <div class="title-box">
        ...
        <h1 class="flex-grow-1">QUẢN LÝ MÔN HỌC</h1>
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="code" min="0" class="form-control" placeholder="Mã Môn học" aria-label="Mã Môn học">
                        </div>
                        <div class="col-12">

                            <input type="text" name="name" min="0" class="form-control" placeholder="Tên môn học" aria-label="Tên môn học">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
