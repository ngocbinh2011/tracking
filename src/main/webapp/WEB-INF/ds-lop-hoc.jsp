...
<div class="container">
    ...
    <div class="title-box">
        ...
        <h1 class="flex-grow-1">QUẢN LÝ LỚP HỌC</h1>
    ...
    <table class="table table-bordered grocery-crud-table table-hover">
        ...
        <c:forEach var="classe" items="${classes}">
            <tr>
                ...
                <td>
                    <a href="/classes/${classe.id}/students">Xem danh sách sinh viên</a>
                    <br>
                    <a href="/classes/${classe.id}/tracking">Điểm danh</a>
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="code" min="0" class="form-control" placeholder="Mã lớp học" aria-label="Mã lớp học">
                        </div>
                        <div class="col-12">

                            <input type="text" name="name" min="0" class="form-control" placeholder="Tên lớp học" aria-label="Tên lớp học">
                        </div>
                        <div class="col-12">

                            <input type="text" name="teacherId" min="0" class="form-control" placeholder="Mã giáo viên giảng dạy" aria-label="Mã giáo viên giảng dạy">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
