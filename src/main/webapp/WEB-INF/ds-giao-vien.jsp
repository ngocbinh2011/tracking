...
<div class="container">
    ...
    <div class="title-box">
        ...
        <h1 class="flex-grow-1">QUẢN LÝ GIẢNG VIÊN</h1>
        ...
        <c:forEach var="teacher" items="${teachers}">
            <tr>
                ...
                <td>
                    ...
                    <form action="/admin/table/delete/${teacher.id}" method="post">
                ...
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-12">
                            ...
                            <input type="text" name="code" min="0" class="form-control" placeholder="Mã giảng viê" aria-label="Mã giảng viên">
                        </div>
                        <div class="col-12">

                            <input type="text" name="name" min="0" class="form-control" placeholder="Tên giảng viên" aria-label="Tên giảng viên">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
