...
<div class="container">
    ...
    <div class="title-box">
        ...
        <h1 class="flex-grow-1">DANH SÁCH SINH VIÊN CỦA LỚP HỌC ${classes.code}</h1>
    ...
    <table class="table table-bordered grocery-crud-table table-hover">
        ...
        <c:forEach var="student" items="${students}">
            <tr>
                ...
                <td>
                    <a href="/tracking/history/${classes.id}/${student.id}">Xem lịch sử điểm danh</a>
                </td>
            </tr>
        </c:forEach>
...
<div class="modal fade" id="modal-add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="/classes/${classes.id}/students" method="post">
                <div class="modal-body">
                    <div class="row g-4">
                        <div class="col-12">

                            <input type="text" name="studentCode" min="0" class="form-control" placeholder="Mã sinh viên" aria-label="Mã sinh viên">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
